...
export const Post = ({
  ...
  return (
    <a href={canonical_url} key={id} className='open'>
      <div className='devitem'>
        {coverimage &&
          (cover_image ? (
            <img className='devblogimg' src={cover_image} alt='cover_image' />
          ) : (
        ...
        <div className='devdetails'>
          <h1 className='devheading'>{title}</h1>
          ...
          <div className='devreact'>
            <div className='devicons'>
              <p>
                ...
                <span className='postreact'> {positive_reactions_count}</span>
              </p>
              <p>
                <svg
                  width='1.2em'
                ...
                <span className='postcomment'> {comments_count}</span>
              </p>
            </div>
            <span className='postpublishdate'>{readable_publish_date}</span>
          </div>
        </div>
      </div>
    </a>
